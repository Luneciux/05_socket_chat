        ...
        <div class="columns">
          ...
          <div class="column register-container">
            ...
            <p class="login-link">
              ...
              <router-link to="/register" class="login-link-anchor">
                <p>Register page</p>
              </router-link>
            </p>
          </div>
      ...
      async submit(event) {
        ...
        if(this.user.password !== null) {
          try {
            ...
            const response = await authenticateUser(this.user)
            ...
            console.log(err)
            alert('Senha errada ou usuário inexistente')
          }
        }    
      }
    }
